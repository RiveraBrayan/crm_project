...
class UsersModel
{
	...
	/* This `usersTable` function in the `UsersModel` class is responsible for fetching user data from
		the database based on the provided filters. Here's a breakdown of what the function does: 
		Create an Array withe the data of the Table*/
	...
	/* The `rolesTable` function in the `UsersModel` class is responsible for fetching role data
		associated with a specific user from the database. Here's a breakdown of what the function does: 
		Create an Array withe the data of the Table*/
	...
	/* The `usersInfo` function in the `UsersModel` class is responsible for fetching user
		information from the database based on the provided `id_user`. Here's a breakdown of what
		the function does: Obtain the user information to show in the form*/
	...
	/* This `saveUsersInfo` function in the `UsersModel` class is responsible for saving or updating user
		information in the database based on the provided fields. Here's a breakdown of what the function
		does: Create or update an user*/
	...
	/* The `saveRolesinfo` function in the `UsersModel` class is responsible for assigning a role to a
		specific user in the database. Here's a breakdown of what the function does: Give a user a Rol*/
