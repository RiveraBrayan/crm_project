...
/* This block of code is checking for specific actions in the request (GET or POST) and then creating
an instance of the `PagesController` class to handle those actions accordingly. */
